...
for a in combi:
    ...
    for b in a:     # Initialer Start der Amplifier mit Startwert
        ...
        liste = liste_src
        out=int_comp(int(b),-1)
        ind_AbisE.append(i)     # Liste mit Indizes der einzelnen Amplifiers
        li_AbisE.append(liste)  # Liste mit den aktuellen Werten der einzelnen Amplifiers

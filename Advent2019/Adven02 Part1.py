liste = [1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,13,1,19,1,6,19,23,2,6,23,27,1,5,27,31,2,31,9,35,1,35,5,39,1,39,5,43,1,43,10,
...
for i in range (0, len(liste), 4):
    ...
    print("I: ", i)
    print("Element1: ", liste[liste[i+1]])
    print("Element2: ", liste[liste[i+2]])
    print("Work: ", liste[i:i+4])
    print(liste)

print("Finale Elemnt: ", liste[0])
